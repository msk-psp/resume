\resumeSubHeadingListStart
    ...
    {\textbf{iOS 애플리케이션 개발 및 배포}}{iOS Developer}
    \resumeItemListStart
        \resumeItem{\textbf{핵심 문제 및 목표: } 미술 관련 콘텐츠를 네이티브 앱에서 보여주고, VR 감상 · 에셋 다운로드 · AR 기능까지 담은 iOS 앱을 만드는 것이 목표.}
        \resumeItem{\textbf{나의 역할: } API 클라이언트를 포함한 백엔드 레이어를 주도해 구축. 작품 · 작가 · 전시 상세 View와 ViewController를 구현했고, Unity Bridge로 Google Cardboard VR을, ARKit으로 Artwork Hanger를 붙였으며, VR 에셋을 내려받는 다운로드 기능도 구현.}
