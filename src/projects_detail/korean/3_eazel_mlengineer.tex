    ...
    \resumeItemListStart
        ...
        \resumeItem{\textbf{문제 해결 과정:}}
            \resumeItemListStart
                ...
                \resumeItem{\textbf{구체적인 구현 내용 (How):} Git과 연동되는 \textbf{DVC를 도입}하여, 모델의 입력 데이터와 산출물을 Git 커밋 해시와 연동하여 버저닝하고 실험의 \textbf{재현성을 확보}함. 이후, 추출한 임베딩 벡터를 입력받아 \textbf{K-Means 클러스터링}과 \textbf{PCA}로 작가 그룹을 분석함. 최종적으로 이 분석 결과를 \textbf{Next.js 및 Cytoscape.js}를 활용하여 상호작용 가능한 네트워크 시각화 대시보드로 구현함. }
            \resumeItemListEnd
    ...
    \resumeItemListStart
        ...
        \resumeItem{\textbf{문제 해결 과정:}}
            \resumeItemListStart
                ...
                \textbf{PostgreSQL} 내에 raw\_data와 purified\_data 스키마를 생성. 
