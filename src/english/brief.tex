...
\begin{itemize}[leftmargin=0.15in, label={}]
    ...
    \item{\textbf{A developer who works with AI agents by default} — most of this Kubernetes platform was written with coding agents running alongside me, and it has been in production for six months. The speed that buys is held honest by 719 SDK unit tests, CI gates, 23 incident write-ups and 30 PRDs.}
