...
\begin{itemize}[leftmargin=0.15in, label={}]
    \small{
    \item{\textbf{Bare-metal Kubernetes reproducible in code} — ingestion to model registry modularized into 12 Pulumi stacks; infrastructure changes tracked in PRs, new environments rebuilt by composing stacks. (1,204 commits, 678 merged PRs.)}
