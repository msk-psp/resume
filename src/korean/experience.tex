...
\resumeSubHeadingListStart
    ...
    \resumeItemListStart
        ...
        \resumeItem{Google Cloud Run에 Flask 기반 Docker Containerized Web server 배포}
    ...
    \resumeItemListStart
        ...
        \resumeItem{Github Action을 이용하여 Continuous Distribution 구현}
    ...
    \resumeItemListStart
        ...
        \resumeItem{Github Action으로 CI/CD 도입}
