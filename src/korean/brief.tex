...
\begin{itemize}[leftmargin=0.15in, label={}]
    ...
    \item{\textbf{온프렘 장비로 세운 베어메탈 Kubernetes}에서 \textbf{10노드 · 상시 pod 235개 · 사내 서비스 23종}을 프로덕션 운영. 클라우드 없이 사내 리소스만으로 클러스터를 구성했고, 23종 전부에 Dex(GitHub OIDC) + oauth2-proxy SSO를 적용해 같은 신원을 Kubernetes RBAC까지 연결.}
...
\begin{itemize}[leftmargin=0.15in, label={}]
    ...
    \textbf{언어·기타}: Python · SQL · JavaScript · Swift · Shell · AWS/GCP
    }}
\end{itemize}
